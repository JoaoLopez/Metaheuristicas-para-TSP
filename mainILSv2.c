#ifndef MAIN_ILS_V2_C
#define MAIN_ILS_V2_C
...
int main(int argc, char *argv[]){
    ...
    for(int i = 4; i < argc; i++){
        ...
        //ILS versão 2
        printf("Executando ILS Versão 2...\n");
        ...
        statusOperacao = solucionarInstanciaTSPILSv2(instanciaTSP, metricas, numeroRepeticoes, alpha);
